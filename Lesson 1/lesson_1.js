const fs = require('fs'); // traz o fs pra ler arquivo, beleza?

// classe do node – cada nó é tipo um cabra na lista encadeada
class Node {
    constructor(data) {
        this.data = data; // guarda o valor no nó
        this.next = null; // o próximo nó começa zerado
    }
}
...
function insertAtPosition(head, data, pos) {
    ...
    // percorre a lista pra achar o lugar certim, tá ligado?
    let current = head;
    let count = 1;
